...
namespace WebServerProject.Services
{
    public interface IGachaService {
        public Task<GachaDrawResult> DrawAsync(int gachaId, int userId);
    }
    ...
    public class GachaService : IGachaService
    {
        ...
        public async Task<GachaDrawResult> DrawAsync(int gachaId, int userId)
        {
            // userId 확인
        ...
        // 보상 지급 처리
        private async Task<GachaRewardResult> GrantGachaRewardAsync(int userId, GachaPool poolItem)
        {
