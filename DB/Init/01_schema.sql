...
CREATE TABLE gacha_masters (
  ...
  soft_pity_threshold INT NOT NULL DEFAULT 0 COMMENT '점진적 확률 증가 시작 회차',
  hard_pity_threshold INT NOT NULL DEFAULT 0 COMMENT '100% 확정 지급 회차',
  pity_bonus_rate DOUBLE NOT NULL DEFAULT 0.0 COMMENT '1스택 당 증가 확률',
  pity_target_rarity INT NOT NULL DEFAULT 4 COMMENT '천장 대상 희귀도'
);
